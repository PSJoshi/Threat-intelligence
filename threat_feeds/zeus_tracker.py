...
class Zeus_tracker(Threat_intelligence_base):
    def __init__(self,feed_url='',proxy_enabled='no',proxy_host=None,proxy_port=None,proxy_user=None,proxy_password=None,proxy_auth=None):
        super(Zeus_tracker, self).__init__(feed_url,proxy_enabled,proxy_host,proxy_port,proxy_user,proxy_password,proxy_auth)
    ...
    def process_feed(self, feed_outputs=None):
        try:
            ...
            if self.feed_data:
                ...
                self.feed_data = self.feed_data[6:]				
